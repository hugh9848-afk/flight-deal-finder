...
export const SETTINGS = {
  ...
  // 우리가 모은 기록만 근거로 '싸다'고 **알릴 때** 필요한 최소 근거입니다.
  //
  // 값이 5건뿐인 기록으로 "20% 싸다"고 알리면, 그 5건이 마침 비쌌던 날이었을 뿐인데
  // 헛알림을 보내게 됩니다. 판정과 화면 표시는 그대로 두고 **알림만** 막습니다.
  // (구글이 준 기준가에는 적용하지 않습니다 — 그건 우리 기록이 아닙니다)
  alertEvidence: {
    minSampleSize: 12,    // 가격을 이만큼은 봤어야
    minDistinctDays: 3,   // 그것도 서로 다른 3일 이상에 걸쳐 봤어야
  },
